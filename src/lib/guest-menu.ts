...
const guestCopyByLocale: Record<LocaleCode, GuestCopy> = {
  en: {
    ...
    getRecommendation: "Recommend me",
    guideMe: "Guide me",
  ...
  es: {
    ...
    getRecommendation: "Recomiéndame",
    guideMe: "Guíame",
  ...
  fr: {
    ...
    getRecommendation: "Recommande-moi",
    guideMe: "Guide-moi",
